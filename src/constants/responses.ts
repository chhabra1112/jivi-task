export class ResponseMessages {
  static readonly MOBILE_OTP_SENT =
    'OTP for mobile verification sent successfully.';
  static readonly INCORRECT_OTP = ' OTP entered is invalid.';
  ...
  static readonly TRANSACTION_DELETED = 'Transaction successfully deleted.';
  static readonly AMOUNT_SETTLED = 'Amount settled successfully.';
}
